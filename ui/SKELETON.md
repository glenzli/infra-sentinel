...
| Reusable time-bucket chart behavior | `src/time_bucket_bar_chart.ts` for hourly/daily quantitative bars and `src/daily_activity_calendar.ts` for recorded-history heatmaps, with their scoped CSS |
