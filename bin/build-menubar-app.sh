...
cp "$ROOT_DIR/bin/infra_agent.py" "$SENTINEL_RESOURCES_DIR/infra_agent.py"
cp "$ROOT_DIR/bin/agent_protocol.py" "$SENTINEL_RESOURCES_DIR/agent_protocol.py"
cp "$ROOT_DIR/bin/billing_policy.py" "$SENTINEL_RESOURCES_DIR/billing_policy.py"
...
cp "$ROOT_DIR/bin/infra_collectors.py" "$SENTINEL_RESOURCES_DIR/infra_collectors.py"
...
cp "$ROOT_DIR/bin/metric_query.py" "$SENTINEL_RESOURCES_DIR/metric_query.py"
