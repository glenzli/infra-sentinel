...
static NSDictionary<NSString *, NSString *> *ChineseStrings(void) {
    ...
    dispatch_once(&onceToken, ^{
        strings = @{
            ...
            @"settings.window_title": @"Traffic Sentinel 设置",
            @"settings.title": @"设置",
            @"settings.subtitle": @"本机 Mihomo 自动发现无需配置；这里只保留告警和远端对账所需的参数。",
            ...
            @"settings.remote_fixed": @"固定使用自动网卡、5 分钟低频读取；Xray StatsService 仅访问远端 127.0.0.1:10085。",
...
static NSDictionary<NSString *, NSString *> *EnglishStrings(void) {
    ...
    dispatch_once(&onceToken, ^{
        strings = @{
            ...
            @"settings.window_title": @"Traffic Sentinel Settings",
            @"settings.title": @"Settings",
            @"settings.subtitle": @"Local Mihomo discovery needs no configuration. Only alert and remote reconciliation inputs remain.",
            ...
            @"settings.remote_fixed": @"Auto interface · 5-minute reads · Xray at remote 127.0.0.1:10085.",
